...
Fonts
	{
		...
		"Default" // button text + shit at bottom
		{
			"1"
			{
				"name"		"Tahoma" 
		...
		"DefaultVerySmall" // settings menu description text idfk
		{
			"1"
			{
				"name"		"Tahoma"
